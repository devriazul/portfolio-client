        ...
        <div class="col-md-6 border border-light p-4">
            ...
            <form action="{{route('experience.update', $experience->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="number" class="form-control rounded" id="exampleInputlanguage21" aria-describedby="language2Help" value="{{$experience->number}}">
                </div>
                <div class="form-group">
                    ...
                    <textarea class="form-control" type='text' name="title" id="" cols="60" rows="5">{{$experience->title}}</textarea>
                </div>
